...
public class ProducerConsumer {
    ...
    static class FileCrawler implements Runnable {
        ...
        private boolean alreadyIndexed(File f) {
            return (indexedFiles.contains(f));
        }
    ...
    static class Indexer implements Runnable {
        ...
        public void indexFile(File file) throws InterruptedException {
            ...
            indexedFiles.put(file);

        };
    }

    /**
     * ArrayList of files that have been indexed
     */
    private static LinkedBlockingQueue<File> indexedFiles=new LinkedBlockingQueue<File>();
    /**
